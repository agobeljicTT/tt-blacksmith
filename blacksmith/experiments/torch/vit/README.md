# ViT with full / partial fine-tuning

This directory contains the code for the ViT (Vision Transformer) model with full / partial fine-tuning experiment.
...
| `wandb_project` | Project name for Weights & Biases logging. | "phi1-finetuning" |
| `wandb_run_name` | Run name for Weights & Biases tracking. | "tt-phi1-sst2" |
...
| `project_dir` | Directory for experiment outputs. | "blacksmith/experiments/torch/phi1" |
